...
Live Demo
Deployed App: https://sustainable-evidence-decisions.replit.app

Try on Your Phone: Download Expo Go from the App Store (iOS) or Google Play (Android), then scan the QR code from the Replit project URL bar to experience the native mobile version.

<img width="155" height="202" alt="image" src="https://github.com/user-attachments/assets/ad667e5b-5153-46a9-817d-d2bf4e29d4c2" />
...
The database and environment variables are auto-provisioned
Click Run - both the backend and frontend start automatically
The web app opens at port 8081 in the Replit webview
...
Start the app on Replit or locally using npm run expo:dev

Scan the QR code that appears:

<img width="155" height="202" alt="image" src="https://github.com/user-attachments/assets/ad00d15b-94f3-44da-825c-070164c16587" />
...
Expo Go opens and loads SEEDi natively on your device

The app hot-reloads as you make code changes
Using a Web Browser
Start the app and open http://localhost:8081 in your browser
Use Chrome DevTools mobile emulation (F12 > Toggle Device Toolbar) to simulate phone screens
Using the Deployed Demo
Visit https://sustainable-evidence-decisions.replit.app to see the live production version. The landing page is at this URL, and the mobile app is accessible through the Expo Go QR code from the Replit project.
...
Define Context - Set your role (Farmer, Policymaker, SME, Researcher, Investor), region, crop types, challenges, and objectives
Explore & Compare - Browse innovations with role-specific relevance explanations, risk badges, and score visualizations. Filter by category, search, and sort by impact/readiness/adoption
Analyze & Simulate - View projected outcomes (yield increase, loss reduction, income potential, soil health), radar charts, before/after comparisons, innovation benchmarks, SDG alignment, and risk assessments
Generate Action - Get a complete action brief with recommended innovations, key indicators, risk notes, and export options
User Roles
